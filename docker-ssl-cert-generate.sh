...
openssl x509 -req -days 365 -in client.csr -CA ca-cert.pem -CAkey ca-key.pem -out client-cert.pem -extfile extfile.cnf

# remove passphrase from private key files if present
